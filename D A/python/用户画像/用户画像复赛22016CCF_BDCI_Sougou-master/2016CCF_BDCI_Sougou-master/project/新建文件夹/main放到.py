...
if __name__ == '__main__':
    ...
    #loading
    trainname = 'after_cuttrain.csv'
    testname = 'after_cuttest.csv'
    traindata = input(trainname)
    testdata = input(testname)
    label_genderfile_path = 'train_data_gender.csv'
    label_agefile_path = 'train_data_age.csv'
    label_edufile_path = 'train_data_education.csv'
...
if __name__ == '__main__':
    ...
    if order=='test':
        ...
        #p1 = multiprocessing.Process(target=termob1.validation,args=(gender_traindatas, genderlabel, wv_gender_traindatas,'gender'))
        p2=multiprocessing.Process(target=termob2.validation,args=(age_traindatas, agelabel, wv_age_traindatas, 'age',))
        #p3=multiprocessing.Process(target=termob3.validation,args=(edu_traindatas, edulabel, wv_edu_traindatas, 'edu',))
        ...
        p1=termob1.validation(gender_traindatas, genderlabel, wv_gender_traindatas, 'gender')
        #p2=termob1.validation(age_traindatas, agelabel, wv_age_traindatas, 'age')
        #p3=termob1.validation(edu_traindatas, edulabel, wv_edu_traindatas, 'edu')
